...
const Star: React.FC<StarPropsType> = ({selected, setSelected}) => {
    let selectedStyle = selected ? style.selected : '';
    return (
        <span>
                <svg onClick={setSelected} className={`${style.star} ${selectedStyle}`} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px"
                     y="0px" width="122.879px" height="117.188px" viewBox="0 0 122.879 117.188"
                     enable-background="new 0 0 122.879 117.188"><g><path
